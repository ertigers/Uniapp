<template>
	<view>
		<view class="box-slideLeft" >
			...
			<view class="touch-item del-box-touch-slideLeft cf-shuCenter">
				<view class="fix" @click="fixItem(item_show)">
					修改
				</view>
				<view class="del" @click="delItem(item_show)">
					删除
				</view>
			</view>
		</view>
